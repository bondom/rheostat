...
function (_React$Component) {
  ...
  function Rheostat(props) {
    ...
    _this.getAdjustedAlgorithmParams = _this.getAdjustedAlgorithmParams.bind((0, _assertThisInitialized2["default"])(_this));
    _this.pitStyleCache = {};
    return _this;
  }
  ...
  _proto.getAdjustedAlgorithmParams = function getAdjustedAlgorithmParams(idx) {
    var handleDimensions = this.state.handleDimensions;
    var sliderBox = this.getSliderBoundingBox();
    var handlePercentage = this.props.orientation === _SliderConstants.VERTICAL ? handleDimensions / sliderBox.height * _SliderConstants.PERCENT_FULL / 2 : handleDimensions / sliderBox.width * _SliderConstants.PERCENT_FULL / 2;
    return {
      idx: idx,
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.handleDimensionsTimeout = setTimeout(function () {
      ...
      _this2.setState({
        ...
        handlePos: _this2.state.values.map(function (value, idx) {
          return algorithm.getPosition(value, min, max, _this2.getAdjustedAlgorithmParams(idx));
        })
      });
    }, 0);
  };
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    var _this$props3 = this.props,
        ...
        pitPoints = _this$props3.pitPoints,
  ...
  _proto.getNextPositionForKey = function getNextPositionForKey(idx, keyCode) {
    ...
    var _this$props6 = this.props,
        ...
        snapPoints = _this$props6.snapPoints,
        shouldSnap = _this$props6.snap;
  ...
  _proto.getNextState = function getNextState(idx, proposedPosition) {
    ...
    return {
      ...
      values: nextHandlePos.map(function (pos, idx) {
        return algorithm.getValue(pos, min, max, _this3.getAdjustedAlgorithmParams(idx));
      })
    };
  };
  ...
  _proto.endSlide = function endSlide() {
    ...
    var _this$props9 = this.props,
        onSliderDragEnd = _this$props9.onSliderDragEnd,
  ...
  _proto.handleClick = function handleClick(ev) {
    ...
    var _this$props10 = this.props,
        ...
        orientation = _this$props10.orientation; // Calculate the position of the slider on the page so we can determine
  ...
  _proto.updateNewValues = function updateNewValues(nextProps) {
    ...
    this.setState({
      handlePos: nextValues.map(function (value, idx) {
        return algorithm.getPosition(value, min, max, _this8.getAdjustedAlgorithmParams(idx));
      }),
      values: nextValues
    });
  };
  ...
  _proto.render = function render() {
    ...
    var _this$props11 = this.props,
        ...
        autoAdjustVerticalPosition = _this$props11.autoAdjustVerticalPosition,
        algorithm = _this$props11.algorithm,
        ...
        PitComponent = _this$props11.pitComponent,
        pitPoints = _this$props11.pitPoints,
        Background = _this$props11.background,
        ProgressBar = _this$props11.progressBar,
    ...
    return (// eslint-disable-next-line jsx-a11y/click-events-have-key-events
      _react["default"].createElement("div", (0, _extends2["default"])({
        ...
        return _react["default"].createElement(Handle, {
          ...
          onKeyDown: disabled ? undefined : _this9.handleKeydown,
          onMouseDown: disabled ? undefined : _this9.startMouseSlide,
          onTouchStart: disabled ? undefined : _this9.startTouchSlide,
          handleRef: _this9.setHandleNode,
          role: "slider",
          style: handleStyle,
          tabIndex: 0
        });
        ...
        var pitStyle = _this9.pitStyleCache[n];
        ...
        if (!pitStyle) {
          ...
          _this9.pitStyleCache[n] = pitStyle;
        }
